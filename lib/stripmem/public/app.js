$(function() {
  ...
  function StripChart(container, name) {
    ...
    var make_x_scale = function() {
      var t = d3.max([currentTime(), chartSize.n]);
      return d3.scale.linear()
        .domain([0, t])
        .range([0, t * width / chartSize.n]);
    };
    var x = make_x_scale();
    ...
    var make_x_axis = function() {
      ...
      return d3.svg.axis().scale(x).tickValues(ticks).orient("bottom");
    };
    ...
    var tick = function() {
      ...
      var t = currentTime();
      var xtrans = x((t > chartSize.n) ? (chartSize.n - t) : 0);
